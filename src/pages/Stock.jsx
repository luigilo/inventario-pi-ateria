...
export default function Stock() {
  ...
  // solo mostrar movimientos cuyo producto exista (no eliminado)
  const displayMovs = useMemo(
    () => movs.filter((m) => products.some((p) => p.id === m.productId)),
    [movs, products]
  );
  ...
  return (
    <div className="p-3">
          ...
          <div className="formgrid grid">
            <div className="field col">
              ...
              <Dropdown
                ...
                onChange={(e) => setForm((s) => ({ ...s, productId: e.value }))}
            ...
            <div className="field col">
              ...
              <Dropdown
                ...
                onChange={(e) => setForm((s) => ({ ...s, type: e.value }))}
              />
            </div>
            <div className="field col">
      ...
      <DataTable value={displayMovs} loading={loading} paginator rows={10} emptyMessage="Sin movimientos" size="small">
        ...
        <Column
          ...
          body={(r) =>
            r.type === "out"
              ? new Intl.NumberFormat("es-CO", { style: "currency", currency: "COP", maximumFractionDigits: 0 }).format(Number(r.priceAtSale || 0))
              : "—"
          }
        />
        <Column
          ...
          body={(r) =>
            r.type === "out"
              ? new Intl.NumberFormat("es-CO", { style: "currency", currency: "COP", maximumFractionDigits: 0 }).format(Number(r.total || 0))
              : "—"
          }
        />
        <Column
          ...
          body={(r) =>
            r.type === "in"
              ? new Intl.NumberFormat("es-CO", { style: "currency", currency: "COP", maximumFractionDigits: 0 }).format(Number(r.costAtEntry || 0))
              : "—"
          }
        />
        <Column
          ...
          body={(r) =>
            r.type === "in"
              ? new Intl.NumberFormat("es-CO", { style: "currency", currency: "COP", maximumFractionDigits: 0 }).format(Number(r.totalCost || 0))
              : "—"
          }
        />
